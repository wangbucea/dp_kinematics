...
def collect_and_visualize():
    ...
    transformer_model = TrajectoryTransformer2(input_dim=state_dim, num_layers=2, nhead=4, max_seq_len=30).to(device)
    
    # 检查模型文件是否存在
    model_path = r'C:\DiskD\trae_doc\robot_gym\model_results\best_transformer_sequence_model.pth'
